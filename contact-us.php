                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input type="text" class="form-control contact-first-name" placeholder="First Name">
            ...
            <div class="row">
                <div class="col-lg-12 ">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="iq-address mt-3">
                                <div class="media ">
                                    ...
                                    <div class="mr-3 contact-icon float-left"><i class="fa fa-map-marker"
                                            aria-hidden="true"></i></div>
                                    <div class="media-body">

                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.<br><span
                                                class="iq-fw-5">
                                            </span></p>
                                    </div>
                                </div>
                                <div class="media ">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="iq-fw-5">Mail@yari.com</p>
                                    </div>
                                </div>
                                <div class="media ">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="iq-fw-5">535547735478</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="iq-breadcrumb-img">
                                <img src="images/breadcrumb/contact-us.png" class="img-fluid breadcrumb-two"
                                    alt="image">
                            </div>
                        </div>
                    </div>
